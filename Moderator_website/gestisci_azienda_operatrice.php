    ...
    if ($nome_azienda) {
        ...
        if ($azienda) {
            ...
            $campi_modificati = [
                ...
                'città' => $città !== null, // Corretto il nome del campo
                'paese' => $paese !== null,
            ...
            $città = $campi_modificati['città'] ? $città : $azienda['città']; // Corretto il nome del campo
            ...
            $update_query = "
                ...
                SET 
                    ...
                    città = :città, -- Corretto il nome del campo
                    paese = :paese,
            ...
            $update_stmt->bindParam(':città', $città); // Corretto il nome del campo
            ...
            $insert_query = "
                INSERT INTO azienda_operatrice (nome_azienda, nome_precedente, sede_legale, città, paese, numero_telefono, email, data_inizio_attivita, descrizione, foto_logo, stato_azienda)
                VALUES (:nome_azienda, :nome_precedente, :sede_legale, :città, :paese, :numero_telefono, :email, :data_inizio_attivita, :descrizione, :foto_logo, :stato_azienda)
            ";
            ...
            $insert_stmt->bindParam(':città', $città); // Corretto il nome del campo
